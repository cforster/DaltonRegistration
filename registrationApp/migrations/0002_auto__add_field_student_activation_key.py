...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.activation_key'
        db.add_column('registrationApp_student', 'activation_key', self.gf('django.db.models.fields.CharField')(default=1, max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Student.activation_key'
        db.delete_column('registrationApp_student', 'activation_key')
