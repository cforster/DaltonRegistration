...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.advisor1NoteRead'
        db.add_column('registrationApp_student', 'advisor1NoteRead', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Student.advisor2NoteRead'
        db.add_column('registrationApp_student', 'advisor2NoteRead', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Student.parentNoteRead'
        db.add_column('registrationApp_student', 'parentNoteRead', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Student.advisor1NoteRead'
        db.delete_column('registrationApp_student', 'advisor1NoteRead')

        # Deleting field 'Student.advisor2NoteRead'
        db.delete_column('registrationApp_student', 'advisor2NoteRead')

        # Deleting field 'Student.parentNoteRead'
        db.delete_column('registrationApp_student', 'parentNoteRead')
