...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Student.advisorNote'
        db.delete_column('registrationApp_student', 'advisorNote')

        # Adding field 'Student.advisor1Note'
        db.add_column('registrationApp_student', 'advisor1Note', self.gf('django.db.models.fields.CharField')(default='ho', max_length=100000), keep_default=False)

        # Adding field 'Student.advisor2Note'
        db.add_column('registrationApp_student', 'advisor2Note', self.gf('django.db.models.fields.CharField')(default=' ', max_length=100000), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Student.advisorNote'
        db.add_column('registrationApp_student', 'advisorNote', self.gf('django.db.models.fields.CharField')(default=' ', max_length=100000), keep_default=False)

        # Deleting field 'Student.advisor1Note'
        db.delete_column('registrationApp_student', 'advisor1Note')

        # Deleting field 'Student.advisor2Note'
        db.delete_column('registrationApp_student', 'advisor2Note')
