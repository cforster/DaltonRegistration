...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.parentNote'
        db.add_column('registrationApp_student', 'parentNote', self.gf('django.db.models.fields.CharField')(default=' ', max_length=100000), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Student.parentNote'
        db.delete_column('registrationApp_student', 'parentNote')
    ...
    models = {
        ...
        'registrationApp.student': {
            ...
            'advisorNote': ('django.db.models.fields.CharField', [], {'max_length': '100000'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'firstName': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
